...
class CartPoleSupervisor(SupervisorCSV):
    ...
    def __init__(self):
        ...
        self.actionSpace = 2
        self.robot1 = self.getFromDef("ROBOT1")
        self.robot2 = self.getFromDef("ROBOT2")

        self.poleEndpoint1 = self.getFromDef("POLE_ENDPOINT_1")
        self.poleEndpoint2 = self.getFromDef("POLE_ENDPOINT_2")
